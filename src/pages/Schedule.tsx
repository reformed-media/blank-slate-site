    ...
    <div className="min-h-screen">
      ...
      <section id="booking" className="py-12 px-8 pb-8 max-md:py-8 max-md:px-5">
        <div className="max-w-[1000px] mx-auto">
          <h2 className="font-montserrat text-[clamp(1.6rem,4vw,2.2rem)] font-extrabold text-center tracking-[2px] mb-4">
            BOOK YOUR <span className="text-[#0099ff]">DETAIL</span>
          </h2>
          <div className="w-[60px] h-[3px] bg-[#0099ff] mx-auto mb-8" />
      ...
      <section className="py-8 px-8 pb-20 max-md:py-6 max-md:px-5 max-md:pb-14">
        <div className="max-w-[700px] mx-auto text-center">
          <div className="p-10 bg-[#111111] border border-[#222] rounded-xl">
            <h3 className="font-montserrat text-[1.2rem] font-bold tracking-[2px] mb-4">
              PREFER TO <span className="text-[#0099ff]">TALK</span>?
            </h3>
