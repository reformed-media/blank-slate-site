    ...
    <div className="min-h-screen">
      ...
      <section className="bg-[#111111] py-20 px-8 max-md:py-14 max-md:px-5">
        <div className="max-w-[800px] mx-auto text-center">
          <h2 className="font-inter text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[3px] mb-6">
      ...
      <section className="bg-[#0a0a0a] py-20 px-8 max-md:py-14 max-md:px-5">
        <h2 className="font-inter text-[clamp(1.8rem,4vw,2.5rem)] font-extrabold text-center tracking-[3px] mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-[1200px] mx-auto">
          {values.map((v) => (
            ...
            >
              ...
              <h3 className="font-inter text-[1.1rem] font-bold tracking-[2px] mb-3">{v.title}</h3>
      ...
      <section className="social-cta-gradient text-center py-20 px-8 border-t border-b border-[#1a1a1a]">
        <h2 className="font-inter text-[clamp(1.6rem,3vw,2.2rem)] font-extrabold tracking-[3px] mb-3">
        ...
        <Link
          to="/schedule"
          className="inline-block px-7 py-3 bg-[#C9A961] text-white font-inter text-[0.85rem] font-bold tracking-[2px] rounded uppercase transition-all duration-300 hover:bg-[#D4B873] hover:shadow-[0_0_25px_rgba(201,169,97,0.3)] hover:-translate-y-0.5"
        >
          BOOK NOW
        </Link>
      </section>
